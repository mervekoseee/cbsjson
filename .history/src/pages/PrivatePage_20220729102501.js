  ...
  const _onCreated = e => {
    ...
    if (layerType === "circlemarker") {
      layer.on('click', function () {
        const group = [[layer.toGeoJSON().geometry.coordinates[0], layer.toGeoJSON().geometry.coordinates[1]]]
        console.log("gruba eklendi"+ group.length())
      ...
      console.log("Çizim oluşturuldu: Polygon oluşturuldu", e.layer._latlngs[0]);
