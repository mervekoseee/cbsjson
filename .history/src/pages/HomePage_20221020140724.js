...
export const HomePage = () =>{
  ...
  <li className="list-group-item">Staj -I/II Çalışma Takvimi <a target="_blank" href="http://bilisim.kocaeli.edu.tr/dosyalar/staj/staj-I_II-takvimi.pdf">Tıklayınız</a></li>
