...
const PrivatePage = () => {
  ...
  const _onCreated = e => {
    ...
    if (layerType === "circlemarker") {
      console.log("Çizim oluşturuldu: circlemaker oluşturuldu.", layerType, layer._latlngs[0][0]);
    }
    ...
    console.log("Çizim oluşturuldu: kare oluşturuldu", layerType, layer._latlngs[0][0[{LatLng}]]);
