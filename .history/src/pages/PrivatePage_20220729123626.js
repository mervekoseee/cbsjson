...
const PrivatePage = () => {
  ...
  const _onEdited = e => {
    ...
    console.log(`Düzenlendi: edited ${numEdited} layers`, e,layers);
  };
  ...
  console.log("Çizim oluşturuldu: kare oluşturuldu", layerType, layer._latlngs[0][0]);
   ...
   if(layer._latlngs[0][0].lat >= circlelat && layer._latlngs[0][0].lng >= circlelng){
    console.log("içeride")
    if(layer._latlngs[0][1].lat >= circlelat && layer._latlngs[0][1].lng >= circlelng){
      console.log("içeride")
      if(layer._latlngs[0][2].lat >= circlelat && layer._latlngs[0][2].lng >= circlelng){
        console.log("içeride")
        if(layer._latlngs[0][0].lat >= circlelat && layer._latlngs[0][0].lng >= circlelng){
          console.log("içeride")
         }else{
