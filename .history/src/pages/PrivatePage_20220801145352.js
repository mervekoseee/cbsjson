...
//  }
  ...
  const onEdited = e => {
    ...
    console.log(e.layers.eachLayer(layer))
    console.log(`Düzenlendi: edited ${numEdited} layers`, e.layers._layers);
  ...
  const onCreated = e => {
    ...
    if (layerType === "circlemarker") {
      ...
      console.log("DENEME" + layerType)
      markerArray.push(markerlatlng);
      console.log("Çizim oluşturuldu: marker oluşturuldu.", markerlatlng.lat);
