  ...
  const _onCreated = e => {
    ...
    if (layerType === "circlemarker") {
      layer.on('click', function(){
        ...
        markerArray.push(selectedMarkers);
      })
      ...
      // console.log("bu Dizi"+ polygonArray)
      console.log(polygonArray[0]);
      console.log(polygonArray[0][0]);
      // console.log(polygonArray[0][1]);
      console.log(polygonArray[0][0][0].lat);
      if(polygonArray.length> 1){
        console.log(polygonArray[1]);
        console.log(polygonArray[1][0]);
      console.log(polygonArray[1][0][0].lat);
      }
