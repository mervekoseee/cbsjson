...
const PrivatePage = () => {
  ...
  const _onCreated = e => {
    ...
    if (layerType === "circlemarker") {
      var circlePos= layer._latlng.lat;
      console.log("Çizim oluşturuldu: circlemaker oluşturuldu.", circlePos);
    ...
    // console.log(circle.latLngs.lat)
    // if(layer._latlngs[0][0].lat <= circle._latlngs.lat && layer._latlngs[0][0].lng <= circle._latlngs.lng){
    //   console.log("içeride");
    // }
