...
const PrivatePage = () => {
  ...
  const _onCreated = e => {
    ...
    if (type === "marker") {
      ...
      console.log("Çizim oluşturuldu: Polyline oluşturuldu.", type, e.layer._latlng);
    }
...
map.drawControl.setDrawingOptions({circlemarker:{shapeOptions:{color: 'red'}}})
        // {e.layer.options.color : 'red}
        
      })
      console.log("Çizim oluşturuldu: circlemaker oluşturuldu.", type, e.layer);
    }
